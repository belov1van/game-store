        ...
        <div className="footer-sections">
          <div className="footer-section">
            <div className="footer-logo">
                <img src="../src/assets/icons/game-controller-svgrepo-com white.svg" alt="" className='login-icon'/>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li><a href="https://github.com/Dzh1224/game-store" target="_blank" rel="noopener noreferrer">repository</a></li>
            </ul>
          </div>
          <div className="footer-section">
