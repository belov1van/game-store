...
const games = [
  ...
  },
  {
    ...
    price: 24.99,
    rating: 4.7,
    description: "A roguelite action-platformer where you control a blob of slime that has taken over the body of a headless knight. Every run is unique thanks to procedurally generated levels, random weapons, and abilities you find along the way. The combat is incredibly fast and fluid, and death here is just the beginning of a new, more powerful run.",
    genre: "Roguelike",
...

  {
    ...
    price: 69.99,
    rating: 4.9,
    description: "The sequel to a legendary saga, where Link gains new abilities that let you literally create weapons, vehicles, and elaborate contraptions on the fly from surrounding objects. Explore not only a familiar but drastically changed surface of Hyrule, but also mysterious sky islands and the dark depths beneath the earth. The game offers absolute freedom in solving puzzles and combat, rewarding the most incredible engineering ideas.",
    genre: "Adventure",
...

  {
    ...
    price: 59.99,
    rating: 4.7,
    description: "The first fully new 2D game in 19 years featuring bounty hunter Samus Aran, continuing the classic storyline. On the planet ZDR, you'll face not only exploration of winding corridors and battles with dangerous robots, but also a lethal hunt from nearly indestructible E.M.M.I. killer machines. These invisible enemies add a slasher-like element, forcing you to constantly run and hide, building a genuine sense of dread.",
    genre: "Metroidvania",
