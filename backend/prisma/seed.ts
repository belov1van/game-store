...
const games = [
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "A groundbreaking role-playing game where you're a detective solving a murder in a unique open world.",
    genre: "RPG",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "Forge your own path in this epic action-adventure through a vast ruined kingdom of insects and heroes.",
    genre: "Metroidvania",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "A rogue-lite, metroidvania inspired, action-platformer with brutal combat and addictive gameplay.",
    genre: "Roguelike",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "A deck-building roguelike that combines card games with dungeon crawling.",
    genre: "Card Game",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "A beautiful platformer with emotional storytelling and stunning visuals.",
    genre: "Platformer",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "An RPG where you don't have to kill anyone. Each enemy can be spared or defeated in a unique way.",
    genre: "RPG",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "A mystery game set in a solar system trapped in an endless time loop.",
    genre: "Adventure",
  ...
  },
  {
    ...
    rating: 4.6,
    description:
      "A puzzle game set on a beautiful, mysterious island filled with hundreds of puzzles.",
    genre: "Puzzle",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "A mystery game about a merchant ship found adrift with all crew members dead or missing.",
    genre: "Puzzle",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "A dark, atmospheric puzzle-platformer from the creators of Limbo.",
    genre: "Puzzle",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "A run and gun game with stunning 1930s cartoon visuals and challenging boss battles.",
    genre: "Action",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "Build and manage automated factories in this deep strategy game.",
    genre: "Strategy",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "The award-winning puzzle game with innovative portal mechanics and hilarious writing.",
    genre: "Puzzle",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "An epic open-world RPG with rich storytelling and memorable characters.",
    genre: "RPG",
  ...
  },
  {
    ...
    rating: 4.5,
    description:
      "An open-world action RPG set in Night City, a megalopolis obsessed with power and body modification.",
    genre: "RPG",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "A fantasy action RPG where players must traverse the Lands Between to become the Elden Lord.",
    genre: "Action RPG",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "Kratos and his son Atreus embark on a journey through the Norse wilds.",
    genre: "Action",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "Rip and tear your way through demon hordes in this fast-paced FPS.",
    genre: "Shooter",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "A remake of the survival horror classic with modern gameplay.",
    genre: "Horror",
  ...
  },
  {
    ...
    rating: 4.4,
    description:
      "An epic space RPG set in a vast universe of planets to explore.",
    genre: "RPG",
  ...
  },
  {
    ...
    rating: 4.6,
    description:
      "An open-world action RPG set in the wizarding world of Harry Potter.",
    genre: "RPG",
  ...
  },
  {
    ...
    rating: 4.3,
    description:
      "The next generation of action RPG, filled with legendary loot and brutal combat.",
    genre: "Action RPG",
  ...
  },
  {
    ...
    rating: 4.6,
    description:
      "A dark fantasy epic with real-time combat and massive Eikon battles.",
    genre: "RPG",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "A survival horror game that blends psychological thriller elements.",
    genre: "Horror",
  ...
  },
  {
    ...
    image:
      "https://m.media-amazon.com/images/I/81lmbDqTpCL._AC_UF894,1000_QL80_.jpg",
    price: 69.99,
    rating: 4.9,
  ...
  },
  {
    ...
    image:
      "https://m.media-amazon.com/images/I/81vEJqLGMVL._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.8,
    description:
      "A new 2D Mario adventure with wonder flowers that transform levels.",
    genre: "Platformer",
  ...
  },
  {
    title: "Metroid Dread",
    image:
      "https://m.media-amazon.com/images/I/81gwhOjwR5L._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.7,
    description:
      "The first 2D Metroid game in 19 years with intense action and exploration.",
    genre: "Metroidvania",
  ...
  },
  {
    ...
    image:
      "https://m.media-amazon.com/images/I/81pZQd4BpIL._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.8,
    description:
      "An expansive JRPG with deep combat and emotional storytelling.",
    genre: "JRPG",
  ...
  },
  {
    ...
    image:
      "https://m.media-amazon.com/images/I/81yYCW6AXZL._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.6,
  ...
  },
  {
    title: "Pikmin 4",
    image:
      "https://m.media-amazon.com/images/I/81o2VrCBvWL._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.7,
    description:
      "Command Pikmin to explore and solve puzzles in this charming strategy game.",
    genre: "Strategy",
  ...
  },
  {
    ...
    image:
      "https://m.media-amazon.com/images/I/81bO+0iQ5-L._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.8,
  ...
  },
  {
    title: "Bayonetta 3",
    image:
      "https://m.media-amazon.com/images/I/81PyGXRTBuL._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.7,
    description:
      "Stylish action combat with demon summoning and dimension-hopping.",
    genre: "Action",
  ...
  },
  {
    ...
    image:
      "https://m.media-amazon.com/images/I/81btTf9tA4L._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.5,
  ...
  },
  {
    ...
    image:
      "https://m.media-amazon.com/images/I/81eWstcfi6L._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.6,
    description:
      "Turn-based tactical combat with Mario and Rabbids characters.",
    genre: "Strategy",
  ...
  },
  {
    title: "Splatoon 3",
    image:
      "https://m.media-amazon.com/images/I/71YhN9A75PL._AC_UF894,1000_QL80_.jpg",
    price: 59.99,
    rating: 4.7,
    description:
      "Ink-based multiplayer shooter with chaotic and colorful battles.",
    genre: "Shooter",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "Hunt massive monsters in this action RPG with wirebug mechanics.",
    genre: "Action",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "A classic JRPG with charming characters and turn-based combat.",
    genre: "JRPG",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "A philosophical action RPG with multiple endings and brilliant combat.",
    genre: "Action RPG",
  ...
  },
  {
    title: "Bloodborne",
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202206/0221/e7VyZ2tIxnN0tUPM67s0HxhT.png",
    price: 39.99,
    rating: 4.9,
  ...
  },
  {
    title: "Demon's Souls",
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202008/2421/xY5iGYkKJd88nqOKVRlR3MsV.png",
    price: 69.99,
    rating: 4.8,
    description:
      "The classic that started the Souls genre, rebuilt from the ground up.",
    genre: "Action RPG",
  ...
  },
  {
    ...
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202011/0616/Xvl9D9QTXejh0Dp0KvUYrPVO.png",
    price: 59.99,
    rating: 4.9,
    description:
      "A samurai epic set in feudal Japan during the Mongol invasion.",
    genre: "Action",
  ...
  },
  {
    ...
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202207/1210/4xJ8XB3biMNk1r2i5Rng8p5L.png",
    price: 59.99,
    rating: 4.8,
    description:
      "Explore a post-apocalyptic world filled with robotic creatures.",
    genre: "Action RPG",
  ...
  },
  {
    ...
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202206/0220/4B6D1LdT3E7Z0gR5cN1a8Y9p.png",
    price: 69.99,
    rating: 4.9,
  ...
  },
  {
    ...
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202111/1716/0VpX5hR4fJ2K1m8L7wN9bY3q.png",
    price: 49.99,
    rating: 4.7,
  ...
  },
  {
    ...
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202011/0412/7xY7V7dN9nL9qL1qW2pM2K2c.png",
    price: 69.99,
    rating: 4.8,
  ...
  },
  {
    title: "Returnal",
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202207/1210/5xM7xN1xZ1xR1xQ1xP1xO1xN1.png",
    price: 69.99,
    rating: 4.7,
    description:
      "A roguelike shooter with time-loop mechanics and intense combat.",
    genre: "Roguelike",
  ...
  },
  {
    ...
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202109/0212/8xY7V7dN9nL9qL1qW2pM2K2c.png",
    price: 49.99,
    rating: 4.6,
    description:
      "A unique open-world game about connecting a fractured society.",
    genre: "Adventure",
  ...
  },
  {
    title: "Days Gone",
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202008/2421/7xY7V7dN9nL9qL1qW2pM2K2c.png",
    price: 39.99,
    rating: 4.5,
    description:
      "Survive in a post-apocalyptic world filled with zombie hordes.",
    genre: "Survival",
  ...
  },
  {
    ...
    image:
      "https://image.api.playstation.com/vulcan/ap/rnd/202008/2421/8xY7V7dN9nL9qL1qW2pM2K2c.png",
    price: 19.99,
    rating: 4.6,
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "A supernatural action game set in a mysterious government building.",
    genre: "Action",
