...
const games = [
  ...
  },
  {
    ...
    price: 59.99,
    rating: 4.8,
    description: 'A fantasy action-RPG set in a vast world designed by Hidetaka Miyazaki and George R.R. Martin.',
    genre: 'Action RPG',
  ...
  },
  {
    ...
    price: 39.99,
    rating: 4.9,
    description: 'America, 1899. The end of the wild west era has begun. After a robbery gone badly wrong, Arthur Morgan and the Van der Linde gang are forced to flee.',
  ...
  },
  {
    ...
    price: 39.99,
    rating: 4.7,
    description: "You're a detective with a unique skill system at your disposal and a whole city to carve your path across.",
    genre: 'RPG',
  ...
  },
  {
    ...
    price: 59.99,
    rating: 4.7,
    description: 'Carve your own clever path to vengeance in this challenging adventure game with a dark and twisted narrative.',
    genre: 'Action Adventure',
  ...
  },
  {
    ...
    price: 39.99,
    rating: 4.3,
    description: 'From legendary game creator Hideo Kojima comes a genre-defining experience: an open world action adventure game.',
    genre: 'Action Adventure',
